...
class ThreePort:
    ...
    def create_y_matrix(self, n_bus: int = -1) -> sparse:
        ...
        self._n_bus = n_bus
        rows, cols, data = [], [], []
        for i, j, k, y11, y12, y13, y21, y22, y23, y31, y32, y33 \
            in zip(self._hv_bus, self._mv_bus, self._lv_bus, self._Y_11, self._Y_12, self._Y_13, self._Y_21, self._Y_22,
                   self._Y_23, self._Y_31, self._Y_32, self._Y_33):
            rows += [i, i, i,
                     j, j, j,
                     k, k, k]
